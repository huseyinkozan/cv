...
% personal data
\name{Hüseyin}{Kozan}
\title{Bilgisayar Mühendisi ve Donanım Tenikeri}   % optional, remove / comment the line if not wanted
\address{Kırşehir}{Türkiye}{}                      % optional, remove / comment the line if not wanted; the "postcode city" and "country" arguments can be omitted or provided empty
...
\section{Mesleki Deneyimler}

\cventry{Haz. 2015 -- ...}{Danışman}{\link[Video Analitik \faExternalLink \hspace{4pt}]{http://www.videoanalitik.com/}}{}{}{
\begin{itemize}
  \item Video Analiz Yazılımı
    \begin{itemize}
      \item PHP, Laravel, October CMS, MySQL, HTML, Javascript ve web teknolojileri konularında destek ve geliştirme. Linux İşletim Sistemi ve veri akışı mimari tasarımı konularında destek.
    \end{itemize}
\end{itemize}}

\cventry{Haz. 2014 -- ...}{Yazılım Mühendisi}{\link[AntSis Elektronik \faExternalLink \hspace{4pt}]{http://antsiselektronik.com.tr/}}{}{}{
\begin{itemize}
  \item Nesnelerin İnterneti (IoT)
    \begin{itemize}
      \item NodeJS, PHP, HTML, Javascript, MQTT ve benzeri teknolojileri kullanarak IoT yönetim yazılımı geliştirmesi.
    \end{itemize}
  \item Coğrafi Bilgi Sistemi (GIS)
    \begin{itemize}
      \item PostGIS, GeoServer, OpenLayers, JQuery, CodeIgniter/PostgreSQL kullanarak Coğrafi Bilgi Sistemi geliştirilmesi.
    \end{itemize}
\end{itemize}}
...
\begin{itemize}
  \item microCOR Lab SDK
    \begin{itemize}
      \item Lab Yazılım Geliştirme Kiti (SDK)'nin tasarımı ve geliştirilmesi. MATLAB mex modülü ile veri alımı.
    \end{itemize}
  \item microCOR Ekg Yazılımı
    \begin{itemize}
      \item DICOM protokolü ve DCMTK araç seti kullanarak hastane otomasyonu entegrasyonu.
    \end{itemize}
    \begin{itemize}
      \item Qt4'den Qt5'e geçirilmesi ve geliştirilmesi.
    \end{itemize}
    \begin{itemize}
      \item Bilgisayar yazılım arayüzünün Android'de ve diğer mobil platformlarda kullanım için geliştirilmesi.
    \end{itemize}
  \item Belgelendirme Sistemi
    \begin{itemize}
      \item ISO 13485 standardına göre Alfresco, Libreoffice, Redmine ve GitLab araçlarının yapılandırılması ve belgelendirme sistemine uyarlanması.
    \end{itemize}
\end{itemize}}
...
\begin{itemize}
  \item \link[microCOR Ekg Cihazı Bilgisayar Yazılımı \tiny \faExternalLink \hspace{4pt}]{http://infron.com.tr/microcor-ekg-cihazi/bilgisayar-yazilimi/}
    \begin{itemize}
      ...
      \item Intel Hex dosyası ile Firmware güncelleme.
...
\section{Proje Bazlı Deneyimler}
...
\section{Açık Kaynak Katkılar}

\cventry{2014}{Qt}{}{}{}{
\begin{itemize}
\item Sonlu Durum Makinası
	\begin{itemize}
      \item \link[Qt-Simple-State \tiny \faExternalLink \hspace{4pt}]{https://github.com/huseyinkozan/Qt-Simple-State} : Basit durum makinası.
	\end{itemize}
...
\begin{itemize}
  \item Pisi Linux (eski ismiyle Pardus) paketleme aracı \link[PiSiDo \tiny \faExternalLink \hspace{4pt}]{https://github.com/huseyinkozan/PiSiDo}
...
\cventry{2015}{Uygulamalı Girişimcilik Sertifikası}{}{}{Gebze Ticaret Odası}{KOSGEB Uygulamalı Girişimcilik Eğitimi.}
...
\cvitem{}{1982 doğumlu. Evli ve iki çocuk babası. A2 ve E sürücü belgelerine sahip. Sigara kullanmıyor. Askerlik görevini yerine getirmiştir.}
