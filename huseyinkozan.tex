...
\address{Cevizli M. Karacabey S. 5/10 Kartal}{İstanbul}{Türkiye}% optional, remove / comment the line if not wanted; the "postcode city" and "country" arguments can be omitted or provided empty
...
\cventry{Haz. 2013 -- ...}{Yazılım Mühendisi}{\link[CTech A.Ş \faExternalLink \hspace{4pt}]{http://ctech.com.tr}}{}{}{
\begin{itemize}%
  ...
  \item Askeri Modem
    ...
    \end{itemize}
  \item Derin Paket İnceleme
    \begin{itemize}
      \item CodeIgniter/RRDTool kullanarak raporlama arayüzü.
    \end{itemize}
\end{itemize}}

\cventry{Oca. -- Eki. 2009,\newline Ara. 2010 -- Haz. 2013}{Yazılım Mühendisi}{\link[Infron Ltd. \faExternalLink \hspace{4pt}]{http://infron.com.tr/}}{}{}{
\begin{itemize}
  \item \link[microCOR Ekg Cihazı Bilgisayar Yazılımı \tiny \faExternalLink \hspace{4pt}]{http://infron.com.tr/microcor-ekg-cihazi/bilgisayar-yazilimi/}
    \begin{itemize}
      \item Qt/C++ ile kullanıcı arayüzü.
...
\subsection{Serbest Çalışma (Freelancer)}
...
\cvitem{Uygulama Çatıları}{Qt, Qwt, CodeIgniter, JQuery OpenGL}
...
\cvitem{Ağ Protokolleri}{TCP/IP, Modeo Protocol, SNMP, Google Protocol Buffer, JSON, MODBUS, RTMP, EPC Gen2}
\cvitem{Veritabanı Sistemleri}{MySQL, SQLite, RRDTool, MS-SQL}
